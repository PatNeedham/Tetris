...
public class Tetris2C extends ColorTetris
{
	public Tetris2C(int x1, int y1, int row, int col, Color c, TetrisPanel t)
	{
		...
		getTetrisPanel().enterGrid(row + 2, col + 1);
	}
	
	public void setLocation(int x, int y)
	{
		r1.setLocation(x + 25, y);
		r2.setLocation(x, y + 25);
		r3.setLocation(x + 25, y + 25);
		r4.setLocation(x + 50, y + 25);
	}
